...
class ProductsTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        */
        ...
        // $categories = factory(Category::class, 1)->create(); //creamos y guardamos 5 categorias
        // $categories->each(function ($c) { //iteramos c/categoria
        //     $products = factory(Product::class, 1)->make(); //generamos 20 productos
        ...
        //         $images = factory(ProductImage::class, 1)->make(); //creamos 5 imagenes
